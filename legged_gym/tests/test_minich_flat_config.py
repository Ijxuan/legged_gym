...
class TestMiniChFlatConfig(unittest.TestCase):
    ...
    def test_flat_task_keeps_domain_randomization_and_starts_fresh(self):
        ...
        self.assertEqual(MiniChFlatCfg.domain_rand.kp_scale_range, [0.8, 1.2])
        self.assertEqual(MiniChFlatCfg.domain_rand.kd_scale_range, [0.8, 1.2])
        self.assertTrue(MiniChFlatCfg.domain_rand.randomize_action_delay)
        self.assertEqual(MiniChFlatCfg.domain_rand.action_delay_sim_steps, [0, 4])
        self.assertEqual(
        ...
        self.assertEqual(MiniChFlatCfg.rewards.scales.zero_command_default_pose, -2.0)
